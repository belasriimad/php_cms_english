    ...
    <div class="row" style="margin-top: 30px;">
        <div class="col-sm-3 col-md-2 sidebar">
           <?php include('includes/sidebar.php');?>
            ...
            <h2 class="sub-header text-primary">Update Post</h2>
            <hr>
                <?php
                    if(!empty($errors)){
                ...
                <form action="editPost.php?id=<?php echo $post['id'];?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <p><span class="text-danger">Current Category :<?php echo $category['name'];?></span></p>
                    ...
                    <p><span class="text-danger">Current Image:</p>
