...
<ul class="nav nav-sidebar list-group">
    ...
    <li><a href="addPost.php"><i class="glyphicon glyphicon-plus-sign"></i> Add new post <span class="sr-only">(current)</span></a></li>
    <li><a href="posts.php"><i class="glyphicon glyphicon-list-alt"></i> Posts</a></li>
    <li><a href="addCategorie.php"><i class="glyphicon glyphicon-plus-sign"></i> Add new category</a></li>
    <li><a href="categories.php"><i class="glyphicon glyphicon-tags"></i> Categories</a></li>
